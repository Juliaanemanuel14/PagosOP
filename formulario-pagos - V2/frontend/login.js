...
function validateField(fieldName) {
  ...
  // Para select, verificar que no sea valor vacío
  // Para input, verificar que no esté vacío después de trim
  const fieldValue = field.tagName === 'SELECT' ? field.value : field.value.trim();
